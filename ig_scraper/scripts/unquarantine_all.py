"""Simple helper to clear quarantine state.

Examples:
  python scripts/unquarantine_all.py --all
  python scripts/unquarantine_all.py --username user@example.com
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Clear account quarantine entries")
